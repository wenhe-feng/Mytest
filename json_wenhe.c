...
void test_jsonc()
{
    ...
    json_object_object_add(para_object, "Name", json_object_new_string("WFeng"));
    json_object_object_add(para_object, "DOB", json_object_new_string("26031987"));
    json_object_object_add(para_object, "Alive", json_object_new_int(1));
